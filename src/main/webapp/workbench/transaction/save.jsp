...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	<script>
		...
		/*
		* 关于阶段和可能性
		* 是一种一一对应的关系 一个阶段对应一个可能性  键值对之间的关系 以阶段为key 通过选中的阶段，触发可能性value
		* 需要properties属性文件进行保存
		* */
		$(function (){
		...
		//	为阶段下拉框，绑定选中下拉框的事件，填写可能性
			...
			//	取得选中的阶段
				...
				// alert(stage);
			//	目标：填写可能性
			//	阶段有了  阶段和可能性之间的对应关系pMap，但是pMap是java语言中的键值对的关系 是（java中map对象）
			//	将pMap转化为js中的键值对关系json
				/*
				* json.key的形式不能取得value  因为stage是一个可变的量  我们要使用的取值方式json[]
				* */
